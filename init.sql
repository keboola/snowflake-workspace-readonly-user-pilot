...
GRANT OWNERSHIP ON DATABASE WORKSPACE_PILOT_DATABASE TO ROLE WORKSPACE_PILOT_ADMIN_ROLE;
GRANT ALL PRIVILEGES ON DATABASE WORKSPACE_PILOT_DATABASE TO ROLE ACCOUNTADMIN;
...
GRANT USAGE ON DATABASE WORKSPACE_PILOT_DATABASE TO ROLE WORKSPACE_PILOT_READONLY_ROLE;
GRANT USAGE ON ALL SCHEMAS IN DATABASE WORKSPACE_PILOT_DATABASE TO ROLE WORKSPACE_PILOT_READONLY_ROLE;
...
CREATE SCHEMA WORKSPACE_PILOT_DATABASE.DEFAULT;
GRANT OWNERSHIP ON SCHEMA WORKSPACE_PILOT_DATABASE.DEFAULT TO ROLE WORKSPACE_PILOT_ADMIN_ROLE;
GRANT USAGE ON ALL SCHEMAS IN DATABASE WORKSPACE_PILOT_DATABASE TO ROLE WORKSPACE_PILOT_READONLY_ROLE;
GRANT USAGE ON DATABASE WORKSPACE_PILOT_DATABASE TO ROLE WORKSPACE_PILOT_READONLY_ROLE;
